...
<div id="content">
	<div class="grid_container">
		<?php 
			...
			echo form_open('admin/reviews/change_reviews_status_global',$attributes) 
		?>
			<div class="grid_12">
						...
						<div style="float: right;line-height:40px;padding:0px 10px;height:39px;">
							...
							?>
								...
								<div class="btn_30_light" style="height: 29px;">
									<a href="admin/reviews/add_review_option_form" class="tipTop" title="<?php if ($this->lang->line('admin_review_add_new_reviews_option_user_or_driver') != '') echo stripslashes($this->lang->line('admin_review_add_new_reviews_option_user_or_driver')); else echo 'Add new review option for user or driver'; ?>">
										<span class="icon accept_co"></span><span class="btn_link"><?php if ($this->lang->line('admin_common_add_new_option') != '') echo stripslashes($this->lang->line('admin_common_add_new_option')); else echo 'Add New Option'; ?></span>
									</a>
								</div>
						 <?php } ?>
								<div class="btn_30_light" style="height: 29px;">
								...
								<tr>
									...
									<td class="center">
										...
										if ($allPrev == '1' || in_array('2', $reviews)){
											...
											if ($mode == '0'){
										?>
											<a title="<?php if ($this->lang->line('common_click_to_inactive') != '') echo stripslashes($this->lang->line('common_click_to_inactive')); else echo 'Click to inactive'; ?>" class="tip_top" href="javascript:confirm_status('admin/reviews/change_reviews_status/<?php echo $mode;?>/<?php echo $row->_id;?>');">
												<span class="badge_style b_done"><?php echo $disp_status;?></span>
											</a>
										<?php
											}else if ($mode == '1'){	
										?>
											<a title="<?php if ($this->lang->line('common_click_to_active') != '') echo stripslashes($this->lang->line('common_click_to_active')); else echo 'Click to active'; ?>" class="tip_top" href="javascript:confirm_status('admin/reviews/change_reviews_status/<?php echo $mode;?>/<?php echo $row->_id;?>')">
									...
									<td class="center">
										<?php if ($allPrev == '1' || in_array('2', $reviews)){?>
											<span>
												<a class="action-icons c-edit" href="admin/reviews/edit_review_option_form/<?php echo $row->_id;?>" title="<?php if ($this->lang->line('admin_common_edit') != '') echo stripslashes($this->lang->line('admin_common_edit')); else echo 'Edit'; ?>">
													<?php if ($this->lang->line('admin_common_edit') != '') echo stripslashes($this->lang->line('admin_common_edit')); else echo 'Edit'; ?>
												</a>
											</span>
                                         <?php /* <span><a class="action-icons c-pencil_basic_red" href="admin/reviews/edit_language_review/<?php echo $row->_id;?>" title="<?php if ($this->lang->line('admin_common_lang_edit') != '') echo stripslashes($this->lang->line('admin_common_lang_edit')); else echo 'Edit Language'; ?>"><?php if ($this->lang->line('admin_common_lang_edit') != '') echo stripslashes($this->lang->line('admin_common_lang_edit')); else echo 'Edit Language'; ?></a></span> */ ?>
										<?php }?>
										<?php if ($allPrev == '1' || in_array('3', $reviews)){?>	
											<span>
												<a class="action-icons c-delete" href="javascript:confirm_delete('admin/reviews/delete_reviews/<?php echo $row->_id;?>')" title="<?php if ($this->lang->line('admin_common_delete') != '') echo stripslashes($this->lang->line('admin_common_delete')); else echo 'Delete'; ?>">
