				...
				<div class="widget_wrap">
					...
					?> 		
	 						<ul>
								...
								<li>
									<div class="form_grid_12">
										<label class="field_title" for="attribute_name"><?php if ($this->lang->line('admin_location_and_fare_availabe_category') != '') echo stripslashes($this->lang->line('admin_location_and_fare_availabe_category')); else echo 'Available Category'; ?><span class="req">*</span></label>
										<div class="form_input">
									...
									<div class="form_grid_12">
										...
										<div class="form_input">
											<div class="night_time_frame">
												<?php if ($this->lang->line('admin_location_and_edit_from') != '') echo stripslashes($this->lang->line('admin_location_and_edit_from')); else echo 'From'; ?>
												<input id="night_time_frame_from" name="night_time_frame[from]" title="<?php if ($this->lang->line('location_enter_night_charge_timing_from') != '') echo stripslashes($this->lang->line('dash_enter_night_charge_timing_from')); else echo 'Enter the night charge timing from'; ?>" type="text" class="small required night_time_input" value="<?php if($form_mode) if(isset($locationdetails->row()->night_time_frame)){ echo $locationdetails->row()->night_time_frame['from']; } ?>" /> 												
												<?php if ($this->lang->line('admin_location_and_edit_to') != '') echo stripslashes($this->lang->line('admin_location_and_edit_to')); else echo 'To'; ?>
												<input id="night_time_frame_to" name="night_time_frame[to]" title="<?php if ($this->lang->line('location_enter_night_charge_timing_to') != '') echo stripslashes($this->lang->line('location_enter_night_charge_timing_to')); else echo 'Enter the night charge timing to'; ?>" type="text" class="small required night_time_input" value="<?php if($form_mode) if(isset($locationdetails->row()->night_time_frame)){ echo $locationdetails->row()->night_time_frame['to']; } ?>" />
											</div>
										</div>
									</div>
								</li>
								...
								<li>
									<div class="form_grid_12">
										...
										<div class="form_input">
											<input name="service_tax" id="service_tax" type="text" tabindex="2" class="large required number tipTop positiveNumber minfloatingNumber" title="<?php if ($this->lang->line('location_enter_service_tax') != '') echo stripslashes($this->lang->line('location_enter_service_tax')); else echo 'Please enter Service tax'; ?>" value="<?php if($form_mode)if(isset($locationdetails->row()->service_tax)){ echo $locationdetails->row()->service_tax; } ?>"/> (%)
										</div>
									</div>
								</li>
								...
								<li>
									<div class="form_grid_12">
										...
										<div class="form_input">
											<input name="site_commission" id="site_commission" type="text" tabindex="2" class="large required number tipTop positiveNumber minfloatingNumber" title="<?php if ($this->lang->line('please_enter_commission_percent_site') != '') echo stripslashes($this->lang->line('please_enter_commission_percent_site')); else echo 'Please enter Commission Percent to site'; ?>" value="<?php if($form_mode)if(isset($locationdetails->row()->site_commission)){ echo $locationdetails->row()->site_commission; } ?>"/> (% <?php if ($this->lang->line('admin_location_and_edit_ride_percent') != '') echo stripslashes($this->lang->line('admin_location_and_edit_ride_percent')); else echo 'of ride'; ?>)
										</div>
									</div>
								</li>
