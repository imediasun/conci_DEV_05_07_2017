					...
					<div id="tab3">
						...
						<ul>
							<li>
								<div class="form_grid_12">
									<div class="form_input">
										<a href="admin/location/display_location_list" class="tipLeft" title="<?php if ($this->lang->line('admin_go_to_location') != '') echo stripslashes($this->lang->line('admin_go_to_location')); else echo 'Go to location list'; ?>"><span class="badge_style b_done"><?php if ($this->lang->line('admin_location_and_fare_back') != '') echo stripslashes($this->lang->line('admin_location_and_fare_back')); else echo 'Back'; ?></span></a>
									</div>
								</div>
							</li>
						</ul>
...
if(isset($location_details->row()->map_searching_radius)){
	$map_radius = intval($location_details->row()->map_searching_radius/1000);
}
$map_language = "";
if($langCode!=''){
