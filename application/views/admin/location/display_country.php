...
<div id="content">
	<div class="grid_container">
		<?php 
			...
			echo form_open('admin/location/change_country_status_global',$attributes) 
		?>
			<div class="grid_12">
								...
								<tr>
									...
									<td class="center">
										...
										if ($allPrev == '1' || in_array('2', $location)){
											...
											if ($mode == '0'){
										?>
											<a title="<?php if ($this->lang->line('common_click_inactive') != '') echo stripslashes($this->lang->line('common_click_inactive')); else echo 'Click to inactive'; ?>" class="tip_top" href="javascript:confirm_status('admin/location/change_country_status/<?php echo $mode;?>/<?php echo $row->_id;?>');">
												<span class="badge_style b_done"><?php echo $row->status;?></span>
											</a>
										<?php
											}else if ($mode == '1'){	
										?>
											<a title="<?php if ($this->lang->line('common_click_active') != '') echo stripslashes($this->lang->line('common_click_active')); else echo 'Click to active'; ?>" class="tip_top" href="javascript:confirm_status('admin/location/change_country_status/<?php echo $mode;?>/<?php echo $row->_id;?>')">
									...
									<td class="center">
										<span>
											<a class="action-icons c-suspend" href="admin/location/view_country/<?php echo $row->_id;?>" title="<?php if ($this->lang->line('admin_common_view') != '') echo stripslashes($this->lang->line('admin_common_view')); else echo 'View'; ?>">
										...
										<?php if ($allPrev == '1' || in_array('2', $location)){?>
											<span>
												<a class="action-icons c-edit" href="admin/location/add_edit_country/<?php echo $row->_id;?>" title="<?php if ($this->lang->line('admin_common_edit') != '') echo stripslashes($this->lang->line('admin_common_edit')); else echo 'Edit'; ?>">
										...
										<?php if ($allPrev == '1' || in_array('3', $location)){?>	
											<span>
												<a class="action-icons c-delete" href="javascript:confirm_delete('admin/location/delete_country/<?php echo $row->_id;?>')" title="<?php if ($this->lang->line('admin_common_delete') != '') echo stripslashes($this->lang->line('admin_common_delete')); else echo 'Delete'; ?>">
