...
<div id="content">
		<div class="grid_container">
			<?php 
				...
				echo form_open('admin/brand/change_model_status_global',$attributes) 
			?>
			<div class="grid_12">
					...
					<div class="widget_top">
						...
						<?php if ($allPrev == '1' || in_array('1', $brand)){?>
							...
							<div class="btn_30_light" style="height: 29px; text-align:left;">
								<a href="admin/brand/add_edit_model" class="tipTop" title="<?php if ($this->lang->line('make_model_add_new_model') != '') echo stripslashes($this->lang->line('make_model_add_new_model')); else echo 'Click here to Add New Model'; ?>"><span class="icon add_co"></span><span class="btn_link"><?php if ($this->lang->line('admin_car_add_new') != '') echo stripslashes($this->lang->line('admin_car_add_new')); else echo 'Add New'; ?></span></a>
							</div>
							...
							<tbody>
								...
								<tr>
									...
									if ($allPrev == '1' || in_array('2', $brand)){
										...
										if ($mode == '0'){
									?>
										<a title="<?php if ($this->lang->line('admin_click_to_unpublish') != '') echo stripslashes($this->lang->line('admin_click_to_unpublish')); else echo 'Click to unpublish'; ?>" class="tip_top" href="javascript:confirm_status('admin/brand/change_model_status/<?php echo $mode;?>/<?php echo $row->_id;?>');"><span class="badge_style b_done"><?php echo $disp_status;?></span></a>
									<?php
										}else {	
									?>
										<a title="<?php if ($this->lang->line('admin_click_to_publish') != '') echo stripslashes($this->lang->line('admin_click_to_publish')); else echo 'Click to publish'; ?>" class="tip_top" href="javascript:confirm_status('admin/brand/change_model_status/<?php echo $mode;?>/<?php echo $row->_id;?>')"><span class="badge_style"><?php echo $disp_status;?></span></a>
									<?php 
										}
									}else {
									?>
