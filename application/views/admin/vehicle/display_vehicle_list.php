...
<div id="content">
		<div class="grid_container">
			<?php 
				...
				echo form_open('admin/vehicle/change_vehicle_status_global',$attributes) 
			?>
			<div class="grid_12">
					...
					<div class="widget_top">
						...
						<?php if ($allPrev == '1' || in_array('1', $vehicle)){?>
							...
							<div class="btn_30_light" style="height: 29px; text-align:left;">
								<a href="admin/vehicle/add_edit_vehicle_type_form" class="tipTop" title="<?php if ($this->lang->line('admin_vehicle_add_new_vehicle') != '') echo stripslashes($this->lang->line('admin_vehicle_add_new_vehicle')); else echo 'Click here to Add New Vehicle'; ?>"><span class="icon add_co"></span><span class="btn_link"><?php if ($this->lang->line('admin_common_add_new') != '') echo stripslashes($this->lang->line('admin_common_add_new')); else echo 'Add New'; ?></span></a>
							</div>
							...
							<tbody>
								...
								<tr>
									...
									if ($allPrev == '1' || in_array('2', $vehicle)){
										...
										if ($mode == '0'){
									?>
										<a title="<?php if ($this->lang->line('admin_click_to_unpublish') != '') echo stripslashes($this->lang->line('admin_click_to_unpublish')); else echo 'Click to unpublish'; ?>" class="tip_top" href="javascript:confirm_status('admin/vehicle/change_vehicle_status/<?php echo $mode;?>/<?php echo $row->_id;?>');"><span class="badge_style b_done"><?php echo $disp_status;?></span></a>
									<?php
										}else {	
									?>
										<a title="<?php if ($this->lang->line('admin_click_to_publish') != '') echo stripslashes($this->lang->line('admin_click_to_publish')); else echo 'Click to publish'; ?>" class="tip_top" href="javascript:confirm_status('admin/vehicle/change_vehicle_status/<?php echo $mode;?>/<?php echo $row->_id;?>')"><span class="badge_style"><?php echo $disp_status;?></span></a>
									<?php 
										}
									}else {
									?>
									...
									<?php if ($allPrev == '1' || in_array('2', $vehicle)){?>
										<span>
											<a class="action-icons c-edit" href="admin/vehicle/add_edit_vehicle_type_form/<?php echo $row->_id;?>" title="<?php if ($this->lang->line('admin_common_edit') != '') echo stripslashes($this->lang->line('admin_common_edit')); else echo 'Edit'; ?>">
									...
									<?php if ($allPrev == '1' || in_array('3', $vehicle)){?>	
										<span>
											<a class="action-icons c-delete" href="javascript:confirm_delete('admin/vehicle/delete_vehicle/<?php echo $row->_id;?>')" title="<?php if ($this->lang->line('admin_common_delete') != '') echo stripslashes($this->lang->line('admin_common_delete')); else echo 'Delete'; ?>">
