...
<div id="content">
    <div class="grid_container">
        ...
        echo form_open('admin/banner/change_banner_status_global', $attributes)
        ?>
        <div class="grid_12">
                    ...
                    <div style="float: right;line-height:40px;padding:0px 10px;height:39px;">
                        <?php if ($allPrev == '1' || in_array('1', $banner)) { ?>
                            ...
                            <div class="btn_30_light" style="height: 29px; text-align:left;">
                                <a href="admin/banner/add_banner_form" class="tipTop" title="<?php if ($this->lang->line('admin_banner_add_new_banner') != '') echo stripslashes($this->lang->line('admin_banner_add_new_banner')); else echo 'Click here to Add New Banner'; ?>"><span class="icon add_co"></span><span class="btn_link"><?php if ($this->lang->line('admin_common_add_new') != '') echo stripslashes($this->lang->line('admin_common_add_new')); else echo 'Add New'; ?></span></a>
                            </div>
                            ...
                            if ($bannerList->num_rows() > 0) {
                                foreach ($bannerList->result() as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="center">
                                            <?php if (isset($row->banner_title)) echo $row->banner_title; ?>
                                        </td>
                                        <td class="center">
                                        ...
                                        <td class="center">
                                            <?php if (isset($row->status)) { ?>
                                                ...
                                                if ($allPrev == '1' || in_array('2', $banner)) {
                                                    ...
                                                    if ($mode == '0') {
                                                        ?>
                                                        <a title="<?php if ($this->lang->line('admin_click_to_unpublish') != '') echo stripslashes($this->lang->line('admin_click_to_unpublish')); else echo 'Click to unpublish'; ?>" class="tip_top" href="javascript:confirm_status('admin/banner/change_banner_status/<?php echo $mode; ?>/<?php echo $row->_id; ?>');"><span class="badge_style b_done"><?php echo $disp_status; ?></span></a>
                                                        <?php
                                                    } else {
                                                        ?>
                                                        <a title="<?php if ($this->lang->line('admin_click_to_publish') != '') echo stripslashes($this->lang->line('admin_click_to_publish')); else echo 'Click to publish'; ?>" class="tip_top" href="javascript:confirm_status('admin/banner/change_banner_status/<?php echo $mode; ?>/<?php echo $row->_id; ?>')"><span class="badge_style"><?php echo $disp_status; ?></span></a>
                                                        <?php
                                                    }
                                                } else {
                                                    ?>
