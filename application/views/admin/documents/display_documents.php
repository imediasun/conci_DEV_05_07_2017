...
<div id="content">
		<div class="grid_container">
			<?php 
				...
				echo form_open('admin/documents/change_document_status_global',$attributes) 
			?>
			<div class="grid_12">
					...
					<div class="widget_top">
						...
						<?php if ($allPrev == '1' || in_array('1', $documents)){?>
							<div class="btn_30_light" style="height: 29px; text-align:left;">
								<a href="admin/documents/add_edit_document_form" class="tipTop" title="<?php if ($this->lang->line('common_validate_add_new_document') != '') echo stripslashes($this->lang->line('common_validate_add_new_document')); else echo 'Click here to Add New Documents'; ?>"><span class="icon add_co"></span><span class="btn_link"><?php if ($this->lang->line('admin_common_add_new') != '') echo stripslashes($this->lang->line('admin_common_add_new')); else echo 'Add New'; ?></span></a>
							</div>
						<?php } ?>
							...
							<div id="DocList_<?php echo $types['category']; ?>" >
								...
								<div class="subview1">
									<span>
										...
										<a href="javascript:confirm_status('admin/documents/change_document_status/0/<?php echo $list->_id; ?>')" class="action-icons c-active" original-title="<?php if ($this->lang->line('common_click_to_inactive') != '') echo stripslashes($this->lang->line('common_click_to_inactive')); else echo 'Click to Inactive'; ?>">
											<span class="badge_style b_done">&nbsp;</span>
										</a>
										<?php }else if($list->status=='Inactive'){ ?>
										<a href="javascript:confirm_status('admin/documents/change_document_status/1/<?php echo $list->_id; ?>')" class="action-icons c-inactive" original-title="<?php if ($this->lang->line('common_click_to_active') != '') echo stripslashes($this->lang->line('common_click_to_active')); else echo 'Click to Active'; ?>">
