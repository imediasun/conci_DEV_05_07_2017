									...
									<li>
										<div class="form_grid_12">
											...
											<div class="form_input">
												...
												<span style="float:right; margin-right:50%;">
												<?php  if(isset($user_details->row()->emergency_contact['verification']['email']))  if($user_details->row()->emergency_contact['verification']['email'] == 'Yes') echo ' - Verified'; else echo ' - Not Verified'; ?>
												</span>
											</div>
										</div>
									</li>
