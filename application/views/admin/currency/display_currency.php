...
<div id="content">
	<div class="grid_container">
		<?php 
			...
			echo form_open('admin/currency/change_currency_status_global',$attributes) 
		?>
			<div class="grid_12">
								...
								<tr>
									...
									<td class="center">
										...
										if ($allPrev == '1' || in_array('2', $currency)){
											...
											if ($mode == '0'){
										?>
											<a title="Click to inactive" class="tip_top" href="javascript:confirm_status('admin/currency/change_currency_status/<?php echo $mode;?>/<?php echo $row->_id;?>');">
												<span class="badge_style b_done"><?php echo $row->status;?></span>
											</a>
										<?php
											}else if ($mode == '1'){	
										?>
											<a title="Click to active" class="tip_top" href="javascript:confirm_status('admin/currency/change_currency_status/<?php echo $mode;?>/<?php echo $row->_id;?>')">
									...
									<td class="center">
										<span>
											<a class="action-icons c-suspend" href="admin/currency/view_currency/<?php echo $row->_id;?>" title="View">
										...
										<?php if ($allPrev == '1' || in_array('2', $currency)){?>
											<span>
												<a class="action-icons c-edit" href="admin/currency/add_edit_currency/<?php echo $row->_id;?>" title="Edit">
										...
										<?php if ($allPrev == '1' || in_array('3', $currency)){?>	
											<span>
												<a class="action-icons c-delete" href="javascript:confirm_delete('admin/currency/delete_currency/<?php echo $row->_id;?>')" title="Delete">
