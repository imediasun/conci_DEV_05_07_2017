				...
				<div class="widget_wrap">
					...
					?>
	 						<ul>
								...
								<li>
								<div class="form_grid_12">
									<label class="field_title" for="admin_name"><?php if ($this->lang->line('admin_subadmin_sub_admin_name') != '') echo stripslashes($this->lang->line('admin_subadmin_sub_admin_name')); else echo 'Sub Admin Name'; ?></label>
									<div class="form_input">
								...
								<div class="form_grid_12">
									<div class="form_input">
										<a href="admin/subadmin/display_sub_admin" class="tipLeft" title="<?php if ($this->lang->line('admin_back_to_subadmin') != '') echo stripslashes($this->lang->line('admin_back_to_subadmin')); else echo 'Go to subadmin list'; ?>"><span class="badge_style b_done"><?php if ($this->lang->line('admin_common_back') != '') echo stripslashes($this->lang->line('admin_common_back')); else echo 'Back'; ?></span></a>
									</div>
								</div>
								</li>
							</ul>
