					...
					<div class="widget_content">
						...
						<tr>
							...
							<th class="tip_top" title="<?php if ($this->lang->line('dash_click_sort') != '') echo stripslashes($this->lang->line('dash_click_sort')); else echo 'Click to sort'; ?>">
								...
								<?php if ($this->lang->line('admin_subadmin_admin_type') != '') echo stripslashes($this->lang->line('admin_subadmin_admin_type')); else echo 'Admin Type'; ?>
							</th>
							<th class="tip_top" title="<?php if ($this->lang->line('dash_click_sort') != '') echo stripslashes($this->lang->line('dash_click_sort')); else echo 'Click to sort'; ?>"> 
						...
						<tr>
							...
							<td class="center">
								<?php if(isset($row->admin_type)) echo get_language_value_for_keyword(ucfirst($row->admin_type),$this->data['langCode']).' '.get_language_value_for_keyword('Admin',$this->data['langCode']);?>
							</td>
							<td class="center">
							...
							if ($allPrev == '1' || in_array('2', $subadmin)){
								...
								if ($mode == '0'){
							?>
								<a title="<?php if ($this->lang->line('common_click_inactive') != '') echo stripslashes($this->lang->line('common_click_inactive')); else echo 'Click to inactive'; ?>" class="tip_top" href="javascript:confirm_status('admin/subadmin/change_subadmin_status/<?php echo $mode;?>/<?php echo $row->_id;?>');"><span class="badge_style b_done"><?php echo $disp_status;?></span></a>
							<?php
								}else {	
							?>
								<a title="<?php if ($this->lang->line('common_click_active') != '') echo stripslashes($this->lang->line('common_click_active')); else echo 'Click to active'; ?>" class="tip_top" href="javascript:confirm_status('admin/subadmin/change_subadmin_status/<?php echo $mode;?>/<?php echo $row->_id;?>')"><span class="badge_style"><?php echo $disp_status;?></span></a>
							<?php 
								}
							}else {
							?>
							...
							<td class="center">
							<?php if ($allPrev == '1' || in_array('2', $subadmin)){?>
								<span><a class="action-icons c-edit" href="admin/subadmin/edit_subadmin_form/<?php echo $row->_id;?>" title="<?php if ($this->lang->line('admin_common_edit') != '') echo stripslashes($this->lang->line('admin_common_edit')); else echo 'Edit'; ?>"><?php if ($this->lang->line('admin_common_edit') != '') echo stripslashes($this->lang->line('admin_common_edit')); else echo 'Edit'; ?></a></span>
							<?php }?>
								<span><a class="action-icons c-suspend" href="admin/subadmin/view_subadmin/<?php echo $row->_id;?>" title="<?php if ($this->lang->line('admin_common_view') != '') echo stripslashes($this->lang->line('admin_common_view')); else echo 'View'; ?>"><?php if ($this->lang->line('admin_common_view') != '') echo stripslashes($this->lang->line('admin_common_view')); else echo 'View'; ?></a></span>
							<?php if ($allPrev == '1' || in_array('3', $subadmin)){?>
								<span><a class="action-icons c-delete" href="javascript:confirm_delete('admin/subadmin/delete_subadmin/<?php echo $row->_id;?>')" title="<?php if ($this->lang->line('admin_common_delete') != '') echo stripslashes($this->lang->line('admin_common_delete')); else echo 'Delete'; ?>"><?php if ($this->lang->line('admin_common_delete') != '') echo stripslashes($this->lang->line('admin_common_delete')); else echo 'Delete'; ?></a></span>
							<?php }?>
							</td>
						</tr>
						<?php 
						...
						<tr>
							...
							<th>
								 <?php if ($this->lang->line('admin_subadmin_admin_name') != '') echo stripslashes($this->lang->line('admin_subadmin_admin_name')); else echo 'Admin Name'; ?>
							</th>
							<th>
								 <?php if ($this->lang->line('admin_subadmin_email') != '') echo stripslashes($this->lang->line('admin_subadmin_email')); else echo 'Email'; ?>
							</th>
