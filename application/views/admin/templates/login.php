...
<?php } ?>
		...
		<?php echo form_open('admin/adminlogin/admin_login');  ?>
			<div class="login_form">
				...
				<ul>
					<li class="login_user tipBot" title="<?php if ($this->lang->line('admin_enter_your_username') != '') echo stripslashes($this->lang->line('admin_enter_your_username')); else echo 'Please enter your username'; ?>">
					<input name="admin_name" value="" type="text" placeholder="<?php if ($this->lang->line('admin_users_users_list_user_name') != '') echo stripslashes($this->lang->line('admin_users_users_list_user_name')); else echo 'User Name'; ?>" >
					</li>
			...
			<ul class="login_opt_link" style="float:left">
				<li style=" margin: 6px 0 0;"><a href="admin/adminlogin/admin_forgot_password_form" class="tipLeft"><?php if ($this->lang->line('admin_login_forgot_password') != '') echo stripslashes($this->lang->line('admin_login_forgot_password')); else echo 'Forgot Password'; ?>?</a></li>
