					...
					?>
						...
						<?php if($template_details->row()->notification_type ==='email'){ ?>
							...
							<li>
								<div class="form_grid_12">
									<div class="form_input">
										<a href="admin/notification/display_notification_templates" class="tipLeft" title="<?php if ($this->lang->line('admin_newsletter_template_list') != '') echo stripslashes($this->lang->line('admin_newsletter_template_list')); else echo 'Go to email templates list'; ?>">
