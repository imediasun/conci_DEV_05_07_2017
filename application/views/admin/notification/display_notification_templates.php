...
<div id="content">
	<div class="grid_container">
		<?php 
			...
			echo form_open('admin/notification/change_notification_newsletter_status_global',$attributes) 
		?>
			<div class="grid_12">
							...
							?>
								<tr>
									...
									<td class="center">
										...
										<span>
											<a class="action-icons c-edit" href="admin/notification/edit_notification_template/<?php echo $row->_id;?>" title="<?php if ($this->lang->line('admin_common_edit') != '') echo stripslashes($this->lang->line('admin_common_edit')); else echo 'Edit'; ?>">
												<?php if ($this->lang->line('admin_common_edit') != '') echo stripslashes($this->lang->line('admin_common_edit')); else echo 'Edit'; ?>
											</a>
										</span>
										<?php }?>
										<span>
											<a class="action-icons c-suspend" href="admin/notification/view_notification_template/<?php echo $row->_id;?>" title="<?php if ($this->lang->line('admin_common_view') != '') echo stripslashes($this->lang->line('admin_common_view')); else echo 'View'; ?>">
												<?php if ($this->lang->line('admin_common_view') != '') echo stripslashes($this->lang->line('admin_common_view')); else echo 'View'; ?>
											</a>
										</span>

										<span>
											<a class="action-icons c-delete" href="javascript:confirm_delete('admin/notification/delete_email_template/<?php echo $row->_id;?>')" title="<?php if ($this->lang->line('admin_common_delete') != '') echo stripslashes($this->lang->line('admin_common_delete')); else echo 'Delete'; ?>">
