...
<div id="content">
	<div class="grid_container">
		<?php 
			...
			echo form_open('admin/promocode/change_promocode_status_global',$attributes) 
		?>
			<div class="grid_12">
								...
								<tr>
									...
									<td class="center">
										...
										if ($allPrev == '1' || in_array('2', $promocode)){
											...
											if ($mode == '0'){
										?>
											<a title="<?php if ($this->lang->line('common_click_to_inactive') != '') echo stripslashes($this->lang->line('common_click_to_inactive')); else echo 'Click to inactive'; ?>" class="tip_top" href="javascript:confirm_status('admin/promocode/change_promocode_status/<?php echo $mode;?>/<?php echo $row->_id;?>');">
												<span class="badge_style b_done"><?php echo $disp_status;?></span>
											</a>
										<?php
											}else if ($mode == '1'){	
										?>
											<a title="<?php if ($this->lang->line('common_click_to_active') != '') echo stripslashes($this->lang->line('common_click_to_active')); else echo 'Click to active'; ?>" class="tip_top" href="javascript:confirm_status('admin/promocode/change_promocode_status/<?php echo $mode;?>/<?php echo $row->_id;?>')">
									...
									<td class="center">
										<?php if ($allPrev == '1' || in_array('2', $promocode)){?>
											<span>
												<a class="action-icons c-edit" href="admin/promocode/edit_promocode_form/<?php echo $row->_id;?>" title="<?php if ($this->lang->line('admin_common_edit') != '') echo stripslashes($this->lang->line('admin_common_edit')); else echo 'Edit'; ?>">
										...
										<?php if ($allPrev == '1' || in_array('3', $promocode)){?>	
											<span>
												<a class="action-icons c-delete" href="javascript:confirm_delete('admin/promocode/delete_promocode/<?php echo $row->_id;?>')" title="<?php if ($this->lang->line('admin_common_delete') != '') echo stripslashes($this->lang->line('admin_common_delete')); else echo 'Delete'; ?>">
