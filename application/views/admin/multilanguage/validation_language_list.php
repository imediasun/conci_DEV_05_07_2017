...
<script type="text/javascript">
    $(document).ready(function () {
        $("#language_select").change(function () {
            ...
            if (filenameId != '') {
                window.open("admin/multilanguage/validation_edit_language/" + filenameId, "_self");
            }
        });
    });
</script>
        ...
        <div class="grid_12">
            <div class="widget_wrap">
                ...
                <div class="widget_content">
                    ...
                    echo form_open('admin/multilanguage/add_edit_keyval_language', $attributes)
                    ?>
                    <ul>
                        <?php
						if($selectedLang!=""){
						...
						if($selectedLang==""){
						?>
						<h2><?php if ($this->lang->line('admin_language_choose_any') != '') echo stripslashes($this->lang->line('admin_language_choose_any')); else echo 'Please choose any language'; ?></h2>
						<?php
						}
                        ?>
