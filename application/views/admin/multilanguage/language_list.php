                    ...
                    <div style="float: right;line-height:40px;padding:0px 10px;height:39px;">
                        <?php if ($allPrev == '1' || in_array('1', $multilang)) { ?>
                            <div class="btn_30_light" style="height: 29px; text-align:left;">
                                <a href="admin/multilanguage/add_new_lg" class="tipTop" title="<?php if ($this->lang->line('admin_language_add_new_language') != '') echo stripslashes($this->lang->line('admin_language_add_new_language')); else echo 'Click here to add new language'; ?>"><span class="icon add_co"></span><span class="btn_link"><?php if ($this->lang->line('admin_common_add_new') != '') echo stripslashes($this->lang->line('admin_common_add_new')); else echo 'Add New'; ?></span></a>
                            </div>
                        <?php } ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="center">
                                            ...
                                            if ($allPrev == '1' || in_array('2', $multilang)) {
                                                ...
                                                if ($mode == '0') {
                                                    ?>
                                                    <a title="<?php if ($this->lang->line('common_click_to_inactive') != '') echo stripslashes($this->lang->line('common_click_to_inactive')); else echo 'Click to Inactive'; ?>" class="tip_top" href="javascript:confirm_status('admin/multilanguage/change_language_status/<?php echo $row->status; ?>/<?php echo $row->_id; ?>');"><span class="badge_style b_done"><?php echo $disp_status; ?></span></a>
                                                    <?php
                                                } else {
                                                    ?>
                                                    <a title="<?php if ($this->lang->line('common_click_to_active') != '') echo stripslashes($this->lang->line('common_click_to_active')); else echo 'Click to Active'; ?>" class="tip_top" href="javascript:confirm_status('admin/multilanguage/change_language_status/<?php echo $row->status; ?>/<?php echo $row->_id; ?>')"><span class="badge_style"><?php echo $disp_status; ?></span></a>
                                                    <?php
                                                }
                                            } else {
                                                ?>
