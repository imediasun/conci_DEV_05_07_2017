            ...
            <div class="widget_wrap">
                <div class="widget_top">
                    ...
                    <div style="float:right">
                        ...
                        <button type="button" class="btn_small btn_blue" style="float:right !important; margin:4px 20px 0 0" onclick="javascript:change_the_another_file('<?php echo $selectedLanguage; ?>');"><span><?php if ($this->lang->line('admin_common_submit') != '') echo stripslashes($this->lang->line('admin_common_submit')); else echo 'Submit'; ?></span></button>
                    </div> 
                </div>
                                ...
                                <li>
                                    <div class="form_grid_12">
                                        ...
                                        <div class="form_input">
                                            <input name="language_vals[]" id="language_vals<?php echo $loopNumber; ?>" value="<?php echo (stripslashes($this->lang->line($language_keys_item))); ?>"  type="text" tabindex="1" class="required large tipTop" title="<?php if ($this->lang->line('admin_language_language') != '') echo stripslashes($this->lang->line('admin_language_language')); else echo 'Please enter the language'; ?>"/>
                                            <input name="languageKeys[]" value="<?php echo stripslashes($language_keys_item); ?>" id="smtp_host" type="hidden" tabindex="1" class="required large tipTop" title="<?php if ($this->lang->line('admin_language_language') != '') echo stripslashes($this->lang->line('admin_language_language')); else echo 'Please enter the language'; ?>"/>                                          
                                        </div>
                                    </div>
                                </li>
