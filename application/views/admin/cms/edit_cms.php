            ...
            <div class="widget_wrap">
                <div class="widget_wrap tabby">
                    <div class="widget_top"> <span class="h_icon list"></span>
						...
						echo  '<input name="english" type="checkbox" value="en"  checked disabled readonly><a href="' . base_url() . 'admin/cms/edit_cms_form/'.$cms_id.'" style="color:white">English</a>';
                        $lang = array();
                        foreach ($langList as $row) {
                            ...
                            if ($row->lang_code != 'en') {
                                if (isset($translated_languages) && in_array($row->lang_code, $translated_languages)) {
                                    echo '<input name="' . $row->name . '" type="checkbox" checked value="' . $row->lang_code . '" disabled readonly><span ' . $styling . '>' . $row->name . "</span>" . '<a href="' . base_url() . 'admin/cms/edit_cms_form/' . $cms_id . '/' . $row->lang_code . '" style="color:red">' . $EditText . '</a>';
                                } else {
                                    echo '<input name="' . $row->name . '" type="checkbox" value="' . $row->lang_code . '" class=""><span ' . $styling . '>' . $row->name . "</span>" . '<a href="' . base_url() . 'admin/cms/edit_cms_form/' . $cms_id . '/' . $row->lang_code . '" style="color:red">' . $EditText . '</a>';
                                }
                            }
                        }
                        ?>
                    ...
                    <div class="widget_content">
                        ...
                        <div id="tab1">
                            <ul>
                                ...
                                if ($cms_details->row()->category == 'Sub') {
                                    ...
                                    <li>
                                        <div class="form_grid_12">
                                            <label class="field_title" for="parent"><?php if ($this->lang->line('admin_cms_select_main_page') != '') echo stripslashes($this->lang->line('admin_cms_select_main_page')); else echo 'Select Main Page'; ?> <span class="req">*</span></label>
                                ...
                                <li>
                                    <div class="form_grid_12">
                                        <label class="field_title" for="page_name"><?php if ($this->lang->line('admin_cms_page_name') != '') echo stripslashes($this->lang->line('admin_cms_page_name')); else echo 'Page Name'; ?> <span class="req">*</span></label>
                                        <div class="form_input">
                                            ...
                                            ?>
                                            <input name="<?php echo $pagename; ?>" id="page_name" type="text" value="<?php echo $page_name_val; ?>" tabindex="2" class="required large tipTop" title="<?php if ($this->lang->line('admin_pages_enter_page_name') != '') echo stripslashes($this->lang->line('admin_pages_enter_page_name')); else echo 'Please enter the page name'; ?>"/>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="form_grid_12">
                                        <label class="field_title" for="page_title"><?php if ($this->lang->line('admin_cms_page_title') != '') echo stripslashes($this->lang->line('admin_cms_page_title')); else echo 'Page Title'; ?> <span class="req">*</span></label>
                                        <div class="form_input">
                                            <?php
                                            if (!empty($lang_code)) {
                                            ...
                                            ?>
                                            <input name="<?php echo $page_title; ?>" id="page_title" type="text" value="<?php echo $page_title_val; ?>" tabindex="2" class="required large tipTop" title="<?php if ($this->lang->line('admin_pages_enter_page_name') != '') echo stripslashes($this->lang->line('admin_pages_enter_page_name')); else echo 'Please enter the page name'; ?>"/>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="form_grid_12">
                                        <label class="field_title" for="description"><?php if ($this->lang->line('admin_cms_css_script') != '') echo stripslashes($this->lang->line('admin_cms_css_script')); else echo 'Css / Script'; ?> <span class="label_intro"><?php if ($this->lang->line('admin_cms_inline_css_and_script') != '') echo stripslashes($this->lang->line('admin_cms_inline_css_and_script')); else echo 'Please write down the content css, inline css and script in this field.'; ?></span></label></label>
                                        <div class="form_input">
                                            <?php
                                            if (!empty($lang_code)) {
                                            ...
                                            ?>
                                            <textarea name="<?php echo $css_descrip; ?>" id="css_descrip" tabindex="3" class="large tipTop" title="<?php if ($this->lang->line('admin_pages_enter_css_and_script') != '') echo stripslashes($this->lang->line('admin_pages_enter_css_and_script')); else echo 'Please enter the css and script'; ?>" style="width:70%;" rows="6"><?php echo $css_descrip_val; ?></textarea>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="form_grid_12">
                                        ...
                                        <div class="form_input">
                                            ...
                                            ?>
                                            <textarea name="<?php echo $description; ?>" tabindex="4" class="large tipTop mceEditor" title="<?php if ($this->lang->line('admin_pages_enter_page_content') != '') echo stripslashes($this->lang->line('admin_pages_enter_page_content')); else echo 'Please enter the page content'; ?>"><?php echo $description_val; ?></textarea>
                                        </div>
                                    </div>
                                </li>
						...
						<div id="tab2" class="meta-tags">
                            <ul>
                                <li>
                                    <div class="form_grid_12">
                                        <label class="field_title" for="meta_title"><?php if ($this->lang->line('admin_cms_use_banner') != '') echo stripslashes($this->lang->line('admin_cms_use_banner')); else echo 'Use Banner'; ?></label>
                                        <div class="form_input">
                                           <?php 
											$use_banner = ''; 
											if (!empty($lang_details)) {
										   ...
										   ?>
											<div class="yes_no1">
                                                <input type="checkbox" tabindex="5" name="use_banner" <?php echo $use_banner; ?> id="yes_no_yes" class="yes_no1" />
                                            </div>
                                ...
                                <li>
                                    <div class="form_grid_12">
                                        <label class="field_title" for="meta_tag"><?php if ($this->lang->line('admin_cms_banner_image') != '') echo stripslashes($this->lang->line('admin_cms_banner_image')); else echo 'Banner Image'; ?></label>
                                        <div class="form_input">
                                            <input name="banner_img" id="banner_img" type="file" tabindex="2" class="large tipTop" title="<?php if ($this->lang->line('admin_pages_choose_banner_image') != '') echo stripslashes($this->lang->line('admin_pages_choose_banner_image')); else echo 'Please choose the banner image'; ?>"/>
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="form_grid_12">
                                        ...
                                        <label class="field_title" for="meta_title"><?php if ($this->lang->line('admin_cms_meta_title') != '') echo stripslashes($this->lang->line('admin_cms_meta_title')); else echo 'Meta Title'; ?>
                                        ...
                                        <div class="form_input">
                                            ...
                                            ?>
                                            <input name="<?php echo $meta_title; ?>" id="meta_title" type="text" value="<?php echo $meta_title_val; ?>" tabindex="1" class="large tipTop" title="<?php if ($this->lang->line('admin_pages_page_meta_title') != '') echo stripslashes($this->lang->line('admin_pages_page_meta_title')); else echo 'Please enter the page meta title'; ?>"/>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="form_grid_12">
                                        <label class="field_title" for="meta_tag"><?php if ($this->lang->line('admin_cms_meta_tag') != '') echo stripslashes($this->lang->line('admin_cms_meta_tag')); else echo 'Meta Tag'; ?>
                                        ...
                                        <div class="form_input">
                                            ...
                                            ?>
                                            <input name="<?php echo $meta_tag; ?>" id="meta_tag" type="text" value="<?php echo $meta_tag_val; ?>" tabindex="2" class="large tipTop" title="<?php if ($this->lang->line('admin_pages_page_meta_tag') != '') echo stripslashes($this->lang->line('admin_pages_page_meta_tag')); else echo 'Please enter the page meta tag'; ?>" />
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="form_grid_12">
                                        <label class="field_title" for="meta_description"><?php if ($this->lang->line('admin_cms_meta_description') != '') echo stripslashes($this->lang->line('admin_cms_meta_description')); else echo 'Meta Description'; ?>
                                        ...
                                        <div class="form_input">
                                            ...
                                            ?>
                                            <textarea name="<?php echo $meta_description; ?>" id="meta_description" tabindex="3" class="large tipTop" title="<?php if ($this->lang->line('admin_pages_page_meta_description') != '') echo stripslashes($this->lang->line('admin_pages_page_meta_description')); else echo 'Please enter the meta description'; ?>"><?php echo $meta_description_val; ?></textarea>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="form_grid_12">
                                        <label class="field_title" for="meta_tag"><?php if ($this->lang->line('meta_abstraction') != '') echo stripslashes($this->lang->line('meta_abstraction')); else echo 'Meta Abstraction (Optional)'; ?>
                                        ...
                                        <div class="form_input">
                                            ...
                                            ?>
                                            <input name="<?php echo $meta_abstraction; ?>" id="meta_abstraction" type="text" value="<?php echo $meta_abstraction_val; ?>" tabindex="2" class="large tipTop" title="<?php if ($this->lang->line('admin_pages_page_meta_abstraction') != '') echo stripslashes($this->lang->line('admin_pages_page_meta_abstraction')); else echo 'Please enter the meta Abstraction'; ?>" />
                                        </div>
                                    </div>
                                </li>
