                    ...
                    <table class="display display_tbl" id="cms_tbl">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="tip_top" title="<?php if ($this->lang->line('dash_click_sort') != '') echo stripslashes($this->lang->line('dash_click_sort')); else echo 'Click to sort'; ?>">
                                    <?php if ($this->lang->line('admin_cms_Category') != '') echo stripslashes($this->lang->line('admin_cms_Category')); else echo 'Category'; ?>
                                </th>
                            ...
                            if ($cmsList->num_rows() > 0) {
                                foreach ($cmsList->result() as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="center">
                                            <?php echo get_language_value_for_keyword($row->category,$this->data['langCode']); ?>
                                        </td>
										<?php /*
                                        <td class="center">
                                            <?php
                                            if ($allPrev == '1' || in_array('2', $cms)) {
                                                ...
                                                if ($mode == 'No') {
                                                    ?>
                                                    <a title="Click to hide this page" class="tip_top" href="javascript:confirm_mode('admin/cms/change_cms_mode/<?php echo $mode; ?>/<?php echo $row->_id; ?>');"><span class="badge_style b_done"><?php echo $row->hidden_page; ?></span></a>
                                                    <?php
                                                } else {
                                                    ?>
                                                    <a title="Click to unhide this page" class="tip_top" href="javascript:confirm_mode('admin/cms/change_cms_mode/<?php echo $mode; ?>/<?php echo $row->_id; ?>')"><span class="badge_style"><?php echo $row->hidden_page; ?></span></a>
                                                    <?php
                                                }
                                            } else {
                                                ?>
										...
										*/ ?>
                                        <td class="center">
                                            ...
                                            if ($allPrev == '1' || in_array('2', $cms)) {
                                                ...
                                                if ($mode == '0') {
                                                    ?>
                                                    <a title="<?php if ($this->lang->line('admin_click_to_unpublish') != '') echo stripslashes($this->lang->line('admin_click_to_unpublish')); else echo 'Click to unpublish'; ?>" class="tip_top" href="javascript:confirm_status('admin/cms/change_cms_status/<?php echo $mode; ?>/<?php echo $row->_id; ?>');"><span class="badge_style b_done"><?php echo $disp_status; ?></span></a>
                                                    <?php
                                                } else {
                                                    ?>
                                                    <a title="<?php if ($this->lang->line('admin_click_to_publish') != '') echo stripslashes($this->lang->line('admin_click_to_publish')); else echo 'Click to publish'; ?>" class="tip_top" href="javascript:confirm_status('admin/cms/change_cms_status/<?php echo $mode; ?>/<?php echo $row->_id; ?>')"><span class="badge_style"><?php echo $disp_status; ?></span></a>
                                                    <?php
                                                }
                                            } else {
                                                ?>
