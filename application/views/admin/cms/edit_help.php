			...
			<div class="grid_12">
				<div class="widget_wrap">
					...
					<?php 
						...
						echo form_open_multipart('admin/cms/edit_help_title',$attributes) 
					?>
						...
						<ul>	 							
							<li>
								...
								<div class="form_input">
									<input name="title" id="title" type="text" value="<?php echo $cms_details->row()->title; ?>" tabindex="1" class="required large tipTop" title="<?php if ($this->lang->line('admin_pages_enter_the_title') != '') echo stripslashes($this->lang->line('admin_pages_enter_the_title')); else echo 'Please enter the title'; ?>"/>
								</div>
								</div>
							</li>						
