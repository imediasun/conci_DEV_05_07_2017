...
<div id="content">
    <div class="grid_container">
        ...
        echo form_open('admin/payment_gateway/change_payment_gateway_status_global', $attributes)
        ?>
        <div class="grid_12">
                            ...
                            <tr>
                                ...
                                <td class="center">
                                    ...
                                    if ($allPrev == '1' || in_array('2', $payment_gateway)) {
                                        ...
                                        if ($mode == '0') {
                                            ?>
                                            <a title="<?php if ($this->lang->line('admin_payment_gateway_click_disable') != '') echo stripslashes($this->lang->line('admin_payment_gateway_click_disable')); else echo 'Click to disable'; ?>" class="tip_top" href="javascript:confirm_status('admin/payment_gateway/pay_by_cash_status/<?php echo $mode; ?>');">
                                                <span class="badge_style b_done"><?php echo $disp_pay_by_cash; ?></span>
                                            </a>
                                            <?php
                                        } else {
                                            ?>
                                            <a title="<?php if ($this->lang->line('admin_payment_gateway_click_enable') != '') echo stripslashes($this->lang->line('admin_payment_gateway_click_enable')); else echo 'Click to enable'; ?>" class="tip_top" href="javascript:confirm_status('admin/payment_gateway/pay_by_cash_status/<?php echo $mode; ?>')">
                            ...
                            <tr>
                                ...
                                <td class="center">
                                    ...
                                    if ($allPrev == '1' || in_array('2', $payment_gateway)) {
                                        ...
                                        if ($mode == '0') {
                                            ?>
                                            <a title="<?php if ($this->lang->line('admin_payment_gateway_click_disable') != '') echo stripslashes($this->lang->line('admin_payment_gateway_click_disable')); else echo 'Click to disable'; ?>" class="tip_top" href="javascript:confirm_status('admin/payment_gateway/use_wallet_amount_status/<?php echo $mode; ?>');">
                                                <span class="badge_style b_done"><?php echo $disp_use_wallet_amount; ?></span>
                                            </a>
                                            <?php
                                        } else {
                                            ?>
                                            <a title="<?php if ($this->lang->line('admin_payment_gateway_click_enable') != '') echo stripslashes($this->lang->line('admin_payment_gateway_click_enable')); else echo 'Click to enable'; ?>" class="tip_top" href="javascript:confirm_status('admin/payment_gateway/use_wallet_amount_status/<?php echo $mode; ?>')">
