...
<div id="content">
  <div class="grid_container">
    <?php 
				...
				echo form_open('admin/templates/change_newsletter_status_global',$attributes) 
			?>
    <div class="grid_12">
        ...
        <div class="widget_top"> <span class="h_icon blocks_images"></span>
          ...
          <div style="float: right;line-height:40px;padding:0px 10px;height:39px;">
            ...
            <div class="lenghtMenu" style="float:left; margin-top:7px;">
              ...
              <select id="mail_contents" data-placeholder="<?php if ($this->lang->line('admin_notification_select_email_template') != '') echo stripslashes($this->lang->line('admin_notification_select_email_template')); else echo 'Select Email Template'; ?>" name="mail_contents" style=" width:300px" class="chzn-select" tabindex="13">
              <option></option>
                <?php 
		  if ($NewsList->num_rows() > 0){
		  foreach ($NewsList->result() as $SendNews){ if($SendNews->news_id->value >13){?>
            ...
            <div class="btn_30_light" style="height: 29px;"> <a href="javascript:void(0)" onclick="return checkBoxWithSelectValidationAdmin('SendMail','<?php echo $subAdminMail; ?>');" class="tipTop" title="<?php if ($this->lang->line('admin_newsletter_checkbox_selct_send_mail_button') != '') echo stripslashes($this->lang->line('admin_newsletter_checkbox_selct_send_mail_button')); else echo 'Select any checkbox and select template click here to send email button'; ?>"><span class="icon email_co"></span><span class="btn_link"><?php if ($this->lang->line('admin_templates_send') != '') echo stripslashes($this->lang->line('admin_templates_send')); else echo 'Send'; ?></span></a> </div>
              ...
              <tr>
                ...
                <td class="center">
				  ...
				  <?php if($row->verify_status == 'Yes'){ ?>
				   <span class="badge_style b_done"><?php echo $row->verify_status;?></span>
				   <?php  } else { ?>
				   <span class="badge_style"><?php echo $row->verify_status;?></span>
				   <?php } ?>
				  
                </td>
                <td class="center">
                  <?php if ($allPrev == '1' || in_array('3', $templates)){?>
                  <span><a class="action-icons c-delete" href="javascript:confirm_delete('admin/templates/delete_subscribers/<?php echo $row->_id;?>')" title="<?php if ($this->lang->line('admin_common_delete') != '') echo stripslashes($this->lang->line('admin_common_delete')); else echo 'Delete'; ?>"><?php if ($this->lang->line('admin_common_delete') != '') echo stripslashes($this->lang->line('admin_common_delete')); else echo 'Delete'; ?></a></span>
                  <?php }?>
                </td>
              </tr>
              <?php 
