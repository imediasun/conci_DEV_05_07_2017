			...
			<div class="widget_wrap">
				<div class="widget_top">
					...
					<h6><?php if ($this->lang->line('admin_templates_languages_available') != '') echo stripslashes($this->lang->line('admin_templates_languages_available')); else echo 'Languages Available'; ?> : 
						...
						echo  '<input name="english" type="checkbox" value="en"  checked disabled readonly><a href="' . base_url() . 'admin/templates/edit_email_template_form/'.$template_id.'" style="color:white">English</a>';
                        $lang = array();
                        foreach ($langList as $row) {
                            ...
                            if ($row->lang_code != 'en') {
                                if (isset($translated_languages) && in_array($row->lang_code, $translated_languages)) {
                                    echo '<input name="' . $row->name . '" type="checkbox" checked value="' . $row->lang_code . '" disabled readonly><span ' . $styling . '>' . $row->name . "</span>" . '<a href="' . base_url() . 'admin/templates/edit_email_template_form/' . $template_id . '/' . $row->lang_code . '" style="color:red">' . $EditText . '</a>';
                                } else {
                                    echo '<input name="' . $row->name . '" type="checkbox" value="' . $row->lang_code . '" class=""><span ' . $styling . '>' . $row->name . "</span>" . '<a href="' . base_url() . 'admin/templates/edit_email_template_form/' . $template_id . '/' . $row->lang_code . '" style="color:red">' . $EditText . '</a>';
                                }
                            }
                        }
                        ?>
					...
					?>
						<ul>
                            ...
                            <?php
                                            ...
                                            ?>
										<input name="<?php echo $sender_name;?>" style=" width:295px" id="sender_name" type="text" tabindex="3" value="<?php echo $sender_name_val;?>" class="required tipTop" title="Please enter the sender name"/>
									</div>
								</div>
							</li>
                            ...
                            <li>
                              ...
                              <?php
                                            ...
                                            ?>
										<input name="<?php echo $sender_email; ?>" style=" width:295px" id="sender_email" type="text" tabindex="4" value="<?php echo $sender_email_val; ?>" class="required tipTop" title="Please enter the sender email address"/>
									</div>
								</div>
							</li> -->
