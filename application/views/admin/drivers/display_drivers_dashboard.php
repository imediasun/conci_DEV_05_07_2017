				...
				<div class="widget_content">
					<table class="wtbl_list">
						...
						<tbody>
							...
							?>
							<tr>
								<td colspan="5" align="center"><?php if ($this->lang->line('admin_menu_dashboard') != '') echo stripslashes($this->lang->line('admin_menu_dashboard')); else echo 'Dashboard'; ?>No Drivers Available</td>
							</tr>
							<?php }?>
						</tbody>
					</table>
