            ...
            <div class="col-lg-12 category_base text-center">
                ...
                foreach ($categoryList as $vehicles) {
                        ...
                        <div class="cate_bdr col-lg-12 nopadd">
                            ...
                            <?php } else { ?>
                                <p><?php
                                    ...
                                    ?></p>
                            <?php } ?>
                            <a href="app/driver/register/<?php echo $this->uri->segment(4) . '/' . urlencode($vehicles['name']); ?>"><input type="button" class=" btn1 category_btn" value="<?php
                    ...
                    <?php
							...
							?>
							<h2 class="text-center"><?php
                                if ($this->lang->line('no_available_catagories_location') != '')
                                    echo stripslashes($this->lang->line('no_available_catagories_location'));
                                else
                                    echo 'NO CATEGORIES AVAILABLE IN THIS LOCATION';
                                ?></h2>
							<?php } ?>
