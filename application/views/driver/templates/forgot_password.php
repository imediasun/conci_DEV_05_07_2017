            ...
            <div class="container-new">
                <div class="login_section col-md-5">
                    <div class="login_inner sign_in_inner">
                        ...
                        <form name="driver_forget_pass_form" id="driver_forget_pass_form" action="driver/profile/driver_forgot_password" method="post" enctype="multipart/form-data">
                            ...
                            <div class="text-center">
                                ...
                                <p><span><?php
                                        if ($this->lang->line('driver_forgot_password_upper') != '')
                                            echo stripslashes($this->lang->line('driver_forgot_password_upper'));
                                        else
                                ...
                                <div class="col-lg-12 text-left sign_driver_text">
                                    <label><?php
                                        if ($this->lang->line('cms_email') != '')
                                            ...
                                            echo 'EMAIL';
                                        ?></label>
                                    <input type="text" class="form-control sign_in_text required email" name="email" placeholder="<?php
                                ...
                                <a href="driver/login" class="tipLeft forgot_password" title="<?php
