...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title><?php echo $this->config->item('email_title'); ?> - Complete Payment</title>
			...
			<div class="shipping_address">
				<div class="main">
					<div class="app-content-box ">
						...
						<h1>Complete Booking <a class="close_btn" href="<?php echo base_url(); ?>mobile/payment/Cancel?mobileId=<?php echo $mobileId; ?>"></a></h1>
						<div class="col-md-11 pay-instructions">
							<h2> Your total charge is <?php echo $this->config->item('currency_symbol').' '.number_format($total_amount,2); ?></h2>
							<span class="payNote"><b>NOTE : </b> Your card information will be saved in stripe secure gateway for your later and faster transaction.</span>
							<form action="<?php echo base_url(); ?>mobile/stripe-manual-payment-process" name="wallet_recharge_form" id="wallet_recharge_form" method="POST" onsubmit="return showLoader();">
								<?php 
