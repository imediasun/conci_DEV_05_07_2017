			...
			<div class="shipping_address">
				<div class="main">		
					<div class="app-content-box">
						...
						transaction.</span>
						<form name="wallet_recharge_form" id="wallet_recharge_form" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>v4/mobile/mobile_wallet_recharge/stripe_payment_process" autocomplete="off" onsubmit="return showLoader();>
