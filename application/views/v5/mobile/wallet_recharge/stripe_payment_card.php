			...
			<div class="shipping_address">
				<div class="main">		
					<div class="app-content-box">
						...
						<h1><?php if ($this->lang->line('wallet_complete_recharge') != '') echo stripslashes($this->lang->line('wallet_complete_recharge')); else echo 'Complete Recharge'; ?> <a class="close_btn" href="<?php echo base_url(); ?>v5/wallet-recharge/pay-cancel?mobileId=<?php echo $trans_details->row()->transaction_id;?>"></a></h1>
						...
						<form name="wallet_recharge_form" id="wallet_recharge_form" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>v5/mobile/mobile_wallet_recharge/stripe_payment_process" autocomplete="off" onsubmit="return showLoader();>
