				...
				<div class="main">		
					<div class="app-content-box">
						...
						<ul>
							...
							<li class="last"><input type="submit" id="submit_btn" class="input-submit-btn" value="<?php if ($this->lang->line('wallet_use_this_card') != '') echo stripslashes($this->lang->line('wallet_use_this_card')); else echo 'Use This Card'; ?>" onClick="return validatecard();"></input></li>
