				...
				<div class="main">
					<div class="app-content-box ">
						...
						<div class="col-md-11 pay-instructions">
							...
							<form action="v5/mobile/mobile_wallet_recharge/stripe_payment_process" name="wallet_recharge_form" id="wallet_recharge_form" method="POST" onsubmit="return showLoader();">
								<?php 
