...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<section>
			...
			<?php $this->output->set_header('refresh:5;url='.base_url().'v5/api/v1/wallet-recharge/pay-completed'); ?>
		</section>
		<?php 
			}
		}
		...
		<section>
			<div class="shipping_address">
					<div class="main">		
						<div class="app-content-box">
						<h1><?php if ($this->lang->line('mobile_view_your_payment_sucess') != '') echo stripslashes($this->lang->line('mobile_view_your_payment_sucess')); else echo 'Your Payment Successful'; ?> <a class="close_btn" href="<?php echo base_url().'v5/mobile/payment/pay-completed'; ?>"></a></h1>
			...
			<?php $this->output->set_header('refresh:2;url='.base_url().'v5/mobile/payment/pay-completed'); ?>
		</section>
		<?php 
			}
		}
