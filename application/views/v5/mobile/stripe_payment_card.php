			...
			<div class="shipping_address">
				<div class="main">		
					<div class="app-content-box">
						...
						<form name="wallet_recharge_form" id="wallet_recharge_form" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>v5/mobile/stripe-manual-payment-process" autocomplete="off" onsubmit="return showLoader();">
						<?php 
						...
						<ul>
							...
							<li><input type="password" class="input-scroll" placeholder="<?php if ($this->lang->line('stripe_security_code') != '') echo stripslashes($this->lang->line('stripe_security_code')); else echo 'Security Code'; ?>" id="creditCardIdentifier" name="cvc_number"></input></li>
							
							<li class="last"><input type="submit" id="submit_btn" class="input-submit-btn" value="<?php if ($this->lang->line('stripe_pay_with_your_card') != '') echo stripslashes($this->lang->line('stripe_pay_with_your_card')); else echo 'Pay With Your Card'; ?>" onClick="return validatecard();"></input></li>
