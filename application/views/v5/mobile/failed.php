	...
	<?php 
		...
		<section>
			<div class="shipping_address">
					<div class="main">		
						...
						<h1><?php if ($this->lang->line('payment_our_payment_failed') != '') echo stripslashes($this->lang->line('payment_our_payment_failed')); else echo 'Your Payment Failed'; ?> - <?php echo urldecode($errors); ?><a class="close_btn" href="<?php echo base_url().'v5/mobile/payment/pay-failed'; ?>"></a></h1>
		...
		<section>
			<div class="shipping_address">
					<div class="main">		
						<div class="app-content-box">
						<h1><?php if ($this->lang->line('payment_our_payment_failed') != '') echo stripslashes($this->lang->line('payment_our_payment_failed')); else echo 'Your Payment Failed'; ?> - <?php echo urldecode($errors); ?><a class="close_btn" href="<?php echo base_url().'mobile/payment/pay-failed'; ?>"></a></h1>
						<div class="payment-success"><img src="<?php echo base_url(); ?>css/mobile/images/failed.png" alt="failed" title="<?php if ($this->lang->line('payment_tittle_failed') != '') echo stripslashes($this->lang->line('payment_tittle_failed')); else echo 'Failed'; ?>" /></div>
					</div>			
					</div>	
			</div>
			<?php $this->output->set_header('refresh:2;url='.base_url().'v5/mobile/payment/pay-failed'); ?>
		</section>
