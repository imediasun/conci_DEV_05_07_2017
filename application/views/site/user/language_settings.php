                            ...
                            <form action="rider/language-settings" method="post" id="languageForm">
                                ...
                                if ($languageList->num_rows() > 0) {
                                    foreach ($languageList->result() as $langs) {
                                        ...
                                        ?>
                                        <label id="longLbl-<?php echo $langs->lang_code; ?>" for="lang-<?php echo $langs->lang_code; ?>" class="longLbl <?php echo $actClass; ?>" onclick="chooseLanguage('<?php echo $langs->lang_code; ?>');">
                                            <?php echo $langs->name; ?>
                                    ...
                                    ?>
                                    <label for="lang-<?php echo $dLangCode; ?>" class="active-lang"><?php echo $dLangName; ?>
