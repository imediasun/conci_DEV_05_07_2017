...
<div class="cms_base_div">
    <div class="container-new cms-container">
		...
		<div class="col-lg-12 app_selecter">
			<label for="stay_signed_in" class="css-label col-md-2" style=" margin-top: 7px; width: 145px !important;">Choose App</label>
			...
			if(count($lang_result) > 0){
				foreach($lang_result as $key => $langs){
					...
					<div class="lang_fields col-lg-12">
						<label for="stay_signed_in" class="css-label col-md-2"><?php echo stripslashes($langs); ?></label>
