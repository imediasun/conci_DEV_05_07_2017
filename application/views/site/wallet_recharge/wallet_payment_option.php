                            ...
                            <div role="tabpanel" class="tab-pane <?php echo $cardActive; ?>" id="card">
                                <form name="PaymentCard" id="PaymentCard" method="post" enctype="multipart/form-data" action="site/wallet_recharge/user_wal_PaymentCard" >
                                    <div class="form-group">
                                        <label for=""><?php if ($this->lang->line('wallet_card_type') != '') echo stripslashes($this->lang->line('wallet_card_type')); else echo 'Card Type'; ?></label>
                                    ...
                                    <div class="form-group">
                                        <label for=""><?php if ($this->lang->line('user_credit_card_number') != '') echo stripslashes($this->lang->line('user_credit_card_number')); else echo 'Credit Card Number'; ?></label>
                                    ...
                                    <div class="form-group">
                                        <label for=""><?php if ($this->lang->line('user_expiration_date') != '') echo stripslashes($this->lang->line('user_expiration_date')); else echo 'Expiration Date'; ?></label>
                                    ...
                                    <div class="form-group">
                                        <label for=""><?php if ($this->lang->line('wallet_security_code') != '') echo stripslashes($this->lang->line('wallet_security_code')); else echo 'Security Code'; ?></label>
