...
<div class="cms_base_div">
    ...
    <div class="container-new cms-container rideTran">
        <section id="cd-timeline" class="cd-container">
            ...
            <div class="cd-timeline-block">
                ...
                <div class="cd-timeline-content">
                    ...
                    <p> 
                        ...
                        <?php if (isset($booking_information['pickup']['location'])) { ?>
                            <b><?php
                                ...
                                ?></b> <?php echo $booking_information['pickup']['location']; ?> <?php if (isset($booking_information['est_pickup_date']->sec)) { ?> on <?php
                                echo date('M d,Y h:i A', $booking_information['est_pickup_date']->sec);
                            }
                            ?> <br/>
                            <?php } ?>
                        ...
                        <?php if (isset($booking_information['drop']['location'])) { ?>
                            ...
                            ?> <?php if (isset($booking_information['drop_date']->sec)) { ?> on <?php
                                    echo date('M d,Y h:i A', $booking_information['drop_date']->sec);
                                }
                                ?> <br/>
                        <?php } ?>
                    ...
                    <span class="cd-date"> <?php
                        if (isset($booking_information['booking_date']->sec)) {
                            echo date('M d,Y h:i A', $booking_information['booking_date']->sec);
                        }
                        ?> </span>
                </div>
            </div>
            ...
            <?php if (isset($ride_details->history['driver_assigned']->sec)) { ?>
                <div class="cd-timeline-block">
                    <div class="cd-timeline-img">
                        <img src="img/cd-icon-location.svg" alt="<?php
                        if ($this->lang->line('rides_location') != '')
                    ...
                    <div class="cd-timeline-content">
                        ...
                        <p><?php
                            ...
                            ?> <?php echo date('M d,Y h:i a', $ride_details->history['driver_assigned']->sec); ?></p>

                        <span class="cd-date"><?php echo date('M d,Y h:i A', $ride_details->history['driver_assigned']->sec); ?></span>
                    </div>
                </div>
                ...
                <div class="cd-timeline-block">
                    ...
                    <div class="cd-timeline-content">
                        <h2><?php
                            ...
                            ?> <?php echo date('h:i a', $tracking['on_time']); ?></h2>
                        <p><?php echo $tracking['locality']; ?></p>
                        <span class="cd-date"><?php echo date('M d,Y  h:i A', $tracking['on_time']); ?></span>
                    </div>
                </div>
                <?php
            }
            ...
            <?php
            if (isset($ride_details->summary) && isset($ride_details->history['end_ride']->sec)) {
                ?>
                ...
                <div class="cd-timeline-block">
                    ...
                    <div class="cd-timeline-content">
                        ...
                        <span class="cd-date"><?php echo date('M d,Y h:i A', $ride_details->history['end_ride']->sec); ?></span>
                    </div>
                </div>
            ...
            <?php
            if ($ride_details->ride_status == 'Cancelled' && isset($ride_details->history['cancelled_time']->sec)) {
                if (isset($ride_details->cancelled)) {
                    ...
                    <div class="cd-timeline-block">
                        ...
                        <div class="cd-timeline-content">
                            ...
                            <span class="cd-date"><?php echo date('M d,Y h:i A', $ride_details->history['cancelled_time']->sec); ?></span>
                        </div>
                    </div>
