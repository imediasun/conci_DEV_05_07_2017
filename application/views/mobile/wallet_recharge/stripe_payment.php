				...
				<div class="main">
					<div class="app-content-box ">
						...
						<div class="col-md-11 pay-instructions">
							<h2> Your total charge is <?php echo $this->config->item('currency_symbol').' '.number_format($trans_details->row()->total_amount,2); ?></h2>
							...
							<form action="mobile/mobile_wallet_recharge/stripe_payment_process" name="wallet_recharge_form" id="wallet_recharge_form" method="POST" onsubmit="return showLoader();">
								<?php 
