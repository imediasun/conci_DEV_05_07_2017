...
/*
  ...
  |
 */
#$config['encryption_key'] = 'SDF43SDFtgfrvv8j79y36482DF489sdf26FSDF8df249df5gh814tjSDF87JGHJUy345';
...
/*
  ...
  |
 */
if (is_file("config-dectar/dectar_app_settings.php")) {
	require_once "config-dectar/dectar_app_settings.php";
}else{
	define('APP_NAME','cabily');
	$config['encryption_key']='SDF43SDFtgfrvv8j79y36482DF489sdf26FSDF8df249df5gh814tjSDF87JGHJUy345';
...
/*
  ...
  |
 */
$config['global_xss_filterig'] = FALSE;
