...
/* Cron Url List */
#$route['send-req-for-later-rides'] = "mobile/ride_later/get_later_rides";
...
$route['app/driver/signup/(:any)'] = "site/app_driver/singupInitiate_category_form";
$route['app/driver/register/(:any)'] = "site/app_driver/singupInitiate_form";
