...
class Sociallogin extends MY_Controller {
	...
	function googleRedirect()
	{
		...
		if($email != ''){
			...
			if($checkUser->num_rows() > 0){
				...
				$google_login_details = array('social_login_name'=>$user_name,'social_login_unique_id'=>'','screen_name'=>$user_name,'social_image_name'=>$userImage,'social_email_name'=>$email,'loginUserType'=>'google','social_user_id'=>$user_id);
	...
	function facebookRedirect(){
		...
		if( $userExist ){
			...
			$google_login_details = array('social_login_name'=>$_SESSION['first_name'],'social_login_unique_id'=>'','screen_name'=>$_SESSION['first_name'],'social_image_name'=>$_SESSION['user_image'],'social_email_name'=>$_SESSION['email'],'loginUserType'=>'facebook','social_user_image'=>$_SESSION['user_image'],'social_user_id'=>$_SESSION['fb_user_id']);
