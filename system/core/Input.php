...
class CI_Input {
    ...
    public function __construct() {
		...
		$unsecurityArr = array('admin_global_settings', 'insertEditCms', 'insertEditEmailtemplate');
		$functionName = $segments[count($segments) - 1];
		if (in_array($functionName, $unsecurityArr)) {
     ...
     * @return	void
     */
    function set_cookie($name = '', $value = '', $expire = '', $domain = '', $path = '/', $prefix = '', $secure = TRUE) {
        if (is_array($name)) {
