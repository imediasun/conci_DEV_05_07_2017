...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_SYS_ROOT_PATH', CONFIG_SYS_MY_DOCROOT.'/uploaded/');   //accept relative path only	define('CONFIG_SYS_FOLDER_SHOWN_ON_TOP', true); //show your folders on the top of list if true or order by name 
