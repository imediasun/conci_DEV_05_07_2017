$(function() {
  ...
  validate:       true
	...
	========================*/
		...
		$('.prod_dev :checkbox').iphoneStyle({ checkedLabel: 'Production', uncheckedLabel: 'Development' });
